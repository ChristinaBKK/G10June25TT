...
const rooming = [
  ...
  { coursePatterns: ['Regular Math A-2'], slotOrders: slotGroups.blockA, teacher: 'Sheryl Shane Canite', room: 'B3009' },
  {
    ...
    teacher: 'Evelyn Yang',
    roomsBySlotOrder: {
      6101: 'B3004', 6102: 'B3004', 6122: 'B3004',
  ...
  { coursePatterns: ['Physics A-2 (Summit)'], slotOrders: slotGroups.blockA, teacher: 'Mike Hu', room: 'B3011' },
  ...
  {
    coursePatterns: ['Economics B-1'],
    teacher: 'Helgaard Le Roux',
    roomsBySlotOrder: {
      6105: 'B2043', 6106: 'B2043', 6107: 'B2043',
      6118: 'B2043', 6119: 'B2043',
      6123: 'B4009', 6124: 'B4009',
      6158: 'B4009', 6159: 'B4009',
      6175: 'B2043', 6176: 'B2043', 6177: 'B2043',
      6188: 'B2043', 6189: 'B2043',
      6298: 'B4009', 6299: 'B4009',
    },
  },
  ...
  { coursePatterns: ['Economics B-2 (Summit)'], slotOrders: slotGroups.blockBCie, teacher: 'Farhan Nzamy', room: 'B4011' },
  ...
  { coursePatterns: ['Theatre HL/SL'], slotOrders: slotGroups.blockB1Ib, teacher: 'Chalice Rakgoale', room: 'B2004' },
  ...
  { coursePatterns: ['Theatre HL/SL'], slotOrders: [...slotGroups.blockB2Ib, 6124], teacher: 'Chalice Rakgoale', room: 'B2004' },
  ...
  { coursePatterns: ['Further Math'], slotOrders: slotGroups.blockC, teacher: 'Rajesh Choyikkunimmal', room: 'B3011' },
  ...
  { coursePatterns: ['Advanced Math D (CIE)'], slotOrders: slotGroups.blockD, teacher: 'Rajesh Choyikkunimmal', room: 'B3043' },
  {
    ...
    roomsBySlotOrder: {
      ...
      6173: 'B4038', 6174: 'B4038', 6183: 'B4038', 6184: 'B4038', 6295: 'B4038',
    },
  },
  ...
  { coursePatterns: ['History'], slotOrders: slotGroups.blockD, teacher: 'Keith Seeley / Matthew Peatman', room: 'B3044' },
  {
    ...
    roomsBySlotOrder: {
      6103: 'B3029, B4029', 6104: 'B3029, B4029', 6113: 'B3029, B4029', 6114: 'B3029, B4029',
      6125: 'B3029, B4029', 6155: 'B3029, B4029', 6168: 'B3029, B4029', 6169: 'B3029, B4029',
      6173: 'B3029, B4029', 6174: 'B3029, B4029', 6183: 'B3029, B4029', 6184: 'B3029, B4029', 6295: 'B3029, B4029',
    },
  },
  {
  ...
  {
    coursePatterns: ['Philosophy HL/SL'],
    teacher: 'Matthew Peatman',
    roomsBySlotOrder: {
      6111: 'B3044', 6112: 'B3044', 6121: 'B3044',
      6151: 'B4010', 6152: 'B4010',
      6165: 'B3044', 6181: 'B3044', 6182: 'B3044', 6185: 'B3044',
      6291: 'B4010', 6292: 'B4010',
    },
  },
  { coursePatterns: ['English E-1*'], slotOrders: slotGroups.blockE, teacher: 'Kurt Shelton', room: 'B4038' },
  { coursePatterns: ['English E-2*'], slotOrders: slotGroups.blockE, teacher: 'Jenna Dunn', room: 'B1029' },
